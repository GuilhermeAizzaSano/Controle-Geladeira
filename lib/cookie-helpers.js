...
function clearCsrfCookie(res, cookieSecure) {
  res.append('Set-Cookie',
    _buildCookieString(CSRF_COOKIE, '', { httpOnly: false, secure: !!cookieSecure, maxAge: 0 }));
}
...
module.exports = {
  ...
  setCsrfCookie, clearCsrfCookie, parseCsrfTokenFromCookie, parseSessionTokenFromCookie,
};
